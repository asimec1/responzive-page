...
<body>
	...
	<main>
		...
		<div id="contact">
			...
			<?php
				print '<p style="text-align:center; padding: 5px; background-color: #d7d6d6;">We recieved your question. We will answer within 24 hours.</p>
				<p>First name: ' . $_POST['firstname'] . '</p>
				<p>Last name: ' . $_POST['lastname'] . '</p>
				<p>E-mail: ' . $_POST['email'] . '</p>
				<p>Country: ' . $_POST['country'] . '</p>
				<p>Subject: ' . $_POST['subject'] . '</p>';
				mail($_POST['email'],'Example page - message',$_POST['subject']);
			?>
		</div>
	</main>
	<footer>
